...
public class JZombiesBuilder implements ContextBuilder<Object> {
	...
	public Context build(Context<Object> context) {
		...
		ContinuousSpace<Object> space = spaceFactory.createContinuousSpace (
				...
				new repast.simphony.space.continuous.WrapAroundBorders(), // continuous wrap around border
				50, 50);
		...
		Grid <Object> grid = gridFactory.createGrid(
				...
				new GridBuilderParameters <Object>(
						...
						new SimpleGridAdder<Object>(), // grid wrap around border
						true , 50, 50)
				);
